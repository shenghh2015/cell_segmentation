...
if args.dataset == 'cycle_736x752':
	...
	dim1, dim2 = 736, 752
if args.dataset == 'cyc2_1488x1512':
...
elif args.dataset == 'cyc2_1488x1512':
	model_folder = '/data/cyc2_models/{}'.format(model_name) if args.docker else './models/cyc2_models/{}'.format(model_name)
