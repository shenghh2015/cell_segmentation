...
if args.dataset == 'cycle_736x752':
	...
	dim1, dim2 = 736, 752
elif '832x832' in args.dataset:
	val_dim1, val_dim2 = 832, 832
	test_dim1, test_dim2 = 832, 832
	dim1, dim2 = 832, 832
elif '800x800' in args.dataset:
	val_dim1, val_dim2 = 800, 800
	test_dim1, test_dim2 = 800, 800
	dim1, dim2 = 800, 800
...
if args.dataset == 'cycle_736x752' or args.dataset == 'viability_c_800x800':
...
elif args.dataset == 'viability3_800x800':
	model_folder = '/data/viability3_models/{}'.format(model_name) if args.docker else './models/viability3_models/{}'.format(model_name)
elif args.dataset == 'viability_c_800x800':
	model_folder = '/data/viability_c_models/{}'.format(model_name) if args.docker else './models/viability_c_models/{}'.format(model_name)
