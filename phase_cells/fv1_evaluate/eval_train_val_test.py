...
subset = args.subset
model_root_folder = '/data/models/fv1_models/'
nb_train_test = 200

model_names = ['single-net-Unet-bone-efficientnetb0-pre-True-epoch-200-batch-4-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-1',
				'single-net-Unet-bone-efficientnetb1-pre-True-epoch-200-batch-4-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-1',
				'single-net-Unet-bone-efficientnetb2-pre-True-epoch-200-batch-4-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-1',
				'single-net-Unet-bone-efficientnetb3-pre-True-epoch-200-batch-3-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-1']
