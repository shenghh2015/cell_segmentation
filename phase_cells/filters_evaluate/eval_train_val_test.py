...
subset = args.subset
model_root_folder = '/data/models/filters_results_0918/'
nb_train_test = 200

model_names = ['single-net-Unet-bone-efficientnetb0-pre-True-epoch-400-batch-10-lr-0.0005-dim-512-train-900-rot-0-set-live_dead-ext-False-loss-focal-up-upsampling-filters-512-red_factor-0.8-pyr_agg-sum-bk-1.0',
				'single-net-Unet-bone-efficientnetb1-pre-True-epoch-400-batch-10-lr-0.0005-dim-512-train-900-rot-0-set-live_dead-ext-False-loss-focal-up-upsampling-filters-512-red_factor-0.8-pyr_agg-sum-bk-1.0',
				'single-net-Unet-bone-efficientnetb2-pre-True-epoch-400-batch-10-lr-0.0005-dim-512-train-900-rot-0-set-live_dead-ext-False-loss-focal-up-upsampling-filters-512-red_factor-0.8-pyr_agg-sum-bk-1.0',
				'single-net-Unet-bone-efficientnetb3-pre-True-epoch-400-batch-10-lr-0.0005-dim-512-train-900-rot-0-set-live_dead-ext-False-loss-focal-up-upsampling-filters-512-red_factor-0.8-pyr_agg-sum-bk-1.0']
