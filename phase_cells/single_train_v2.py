...
model_name = 'single-net-{}-bone-{}-pre-{}-epoch-{}-batch-{}-lr-{}-dim-{}-train-{}-rot-{}-set-{}-ext-{}-loss-{}-up-{}-filters-{}'.format(args.net_type,\
		 	args.backbone, args.pre_train, args.epoch, args.batch_size, args.lr, args.dim,\
		 	args.train, args.rot, args.dataset, args.ext, args.loss, args.upsample, args.filters)
print(model_name)
...
model.save_weights(model_folder+'/model_best.h5')
