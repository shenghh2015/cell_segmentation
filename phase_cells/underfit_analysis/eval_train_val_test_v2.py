...
model_root_folder = '/data/models/underfit_analysis/retrain-dim-992/'
nb_train_test = 200

model_names = ['single-net-Unet-bone-efficientnetb2-pre-True-epoch-200-batch-3-lr-0.0005-dim-992-train-1100-rot-0-set-cell_cycle_1984-ext-False-loss-focal+dice-up-upsampling-filters-256',
			   'single-net-Unet-bone-efficientnetb2-pre-True-epoch-200-batch-3-lr-0.0005-dim-992-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256']
index = 1
