...
model_root_folder = '/data/models/underfit_analysis/'
nb_train_test = 200

model_names = ['cellcycle-net-Unet-bone-efficientnetb0-pre-True-epoch-120-batch-3-lr-0.0005-down-True-dim-1024-train-1100-bk-0.5-rot-0-set-1984_v2-ext-True-fact-1-loss-focal+dice',
			   'cellcycle-net-Unet-bone-efficientnetb1-pre-True-epoch-120-batch-3-lr-0.0005-down-True-dim-1024-train-1100-bk-0.5-rot-0-set-1984_v2-ext-True-fact-1-loss-focal+dice',
			   'cellcycle-net-Unet-bone-efficientnetb2-pre-True-epoch-120-batch-3-lr-0.0005-down-True-dim-1024-train-1100-bk-0.5-rot-0-set-1984_v2-ext-True-fact-1-loss-focal+dice',
			   'cellcycle-net-Unet-bone-efficientnetb3-pre-True-epoch-120-batch-2-lr-0.0005-down-True-dim-1024-train-1100-bk-0.5-rot-0-set-1984_v2-ext-True-fact-1-loss-focal+dice',
			   'cellcycle-net-Unet-bone-efficientnetb1-pre-True-epoch-200-batch-7-lr-0.0005-down-True-dim-800-train-1100-bk-0.5-rot-0.0-set-1984',
			   'cellcycle-net-Unet-bone-efficientnetb2-pre-True-epoch-200-batch-7-lr-0.0005-down-True-dim-800-train-1100-bk-0.5-rot-0.0-set-1984',
			   'cellcycle-net-Unet-bone-efficientnetb3-pre-True-epoch-300-batch-4-lr-0.0005-down-True-dim-800-train-1100-bk-0.5-rot-0.0-set-1984']
