...
subset = args.subset
model_root_folder = '/data/models/AtUnet/'
nb_train_test = 200

model_names = ['single-net-AtUnet-bone-efficientnetb0-pre-True-epoch-300-batch-3-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-None',
				'single-net-AtUnet-bone-efficientnetb1-pre-True-epoch-300-batch-3-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-None',
				'single-net-AtUnet-bone-efficientnetb2-pre-True-epoch-300-batch-3-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-None',
				'single-net-AtUnet-bone-efficientnetb3-pre-True-epoch-300-batch-2-lr-0.0005-dim-1024-train-1100-rot-0-set-cell_cycle_1984_v2-ext-True-loss-focal+dice-up-upsampling-filters-256-red_factor-0.8-pyr_agg-sum-bk-1.0-fl_weight-4.0-fv-None']
...
for v in range(len(splits)):
	if splits[v]=='set':
		...
		net_arch = splits[v+1]; print(net_arch)
	elif splits[v] == 'bone':
		backbone = splits[v+1]
	elif splits[v] == 'up':
		upsample = splits[v+1]
